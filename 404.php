...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-family: 'Playfair Display', serif; font-size: 8rem; font-weight: 700; background: linear-gradient(135deg, #d4af37, #f0d060); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1; margin-bottom: 0; }
        .error-divider { width: 80px; height: 3px; background: linear-gradient(90deg, #d4af37, #f0d060); margin: 24px auto; border-radius: 2px; }
        ...
        .glow-orb { position: fixed; width: 400px; height: 400px; border-radius: 50%; background: radial-gradient(circle, rgba(212,175,55,0.08), transparent 70%); pointer-events: none; }
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-message">The page you are looking for doesn't exist or has been moved. Please check the URL or navigate back to the homepage.</p>
