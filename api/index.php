...
$file_map = [
    ...
    '/inventory/ajax/save-item'                             => 'inventory/ajax/save-item.php',
    '/inventory/ajax/update-item'                           => 'inventory/ajax/update-item.php',
...
$file_map['/owner/branches']                           = 'owner/branches.php';
$file_map['/owner/bookings']                           = 'owner/bookings.php';
$file_map['/owner/coupons']                            = 'owner/coupons.php';
$file_map['/owner/customers']                          = 'owner/customers.php';
$file_map['/owner/inventory-overview']                 = 'owner/inventory-overview.php';
$file_map['/owner/occupancy']                          = 'owner/occupancy.php';
$file_map['/owner/payments']                           = 'owner/payments.php';
$file_map['/owner/reports']                            = 'owner/reports.php';
$file_map['/owner/restaurant-sales']                   = 'owner/restaurant-sales.php';
$file_map['/owner/revenue']                            = 'owner/revenue.php';
$file_map['/owner/settings']                           = 'owner/settings.php';
$file_map['/owner/send-notification']                   = 'owner/send-notification.php';
$file_map['/owner/staff']                              = 'owner/staff.php';
