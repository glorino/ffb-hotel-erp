    ...
    <div class="container">
        ...
        <div class="listing-grid">
            ...
            <?php $fallback = [
                ...
                ['id' => 5, 'room_number' => 'The Orchid Suite', 'price_per_night' => 350000, 'type_name' => 'Luxury Suite', 'desc' => 'Refined furnishings with exclusive perks and city views', 'amenities' => 'WiFi, Living Room, Jacuzzi, Full Bar, Butler Service', 'max_guests' => 3, 'area' => 60, 'img' => 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 6, 'room_number' => 'Obsidian', 'price_per_night' => 180000, 'type_name' => 'Executive Room', 'desc' => 'Premium business amenities with lounge access', 'amenities' => 'WiFi, Mini Bar, TV, Lounge Access, Coffee Machine', 'max_guests' => 2, 'area' => 45, 'img' => 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 7, 'room_number' => 'Amethyst', 'price_per_night' => 180000, 'type_name' => 'Executive Room', 'desc' => 'Refined furnishings with exclusive perks', 'amenities' => 'WiFi, Mini Bar, TV, Lounge Access, Coffee Machine', 'max_guests' => 2, 'area' => 45, 'img' => 'https://images.unsplash.com/photo-1582719508461-905c673771fd?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 8, 'room_number' => 'Garnet', 'price_per_night' => 180000, 'type_name' => 'Executive Room', 'desc' => 'Perfect for business travelers', 'amenities' => 'WiFi, Mini Bar, TV, Lounge Access, Coffee Machine', 'max_guests' => 2, 'area' => 42, 'img' => 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=400&h=280&fit=crop', 'status' => 'available'],
            ];
