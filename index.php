...
<section class="section-padding" id="rooms">
    <div class="container">
        ...
        <div class="listing-grid">
            ...
            <?php $fallback = [
                ['id' => 1, 'room_number' => 'The Crown Penthouse', 'branch_id' => 1, 'room_type_id' => 5, 'price_per_night' => 950000, 'type_name' => 'Penthouse', 'desc' => 'Ultra-luxury penthouse with rooftop terrace and 24/7 concierge', 'amenities' => 'WiFi, Rooftop Terrace, Private Pool, Cinema, Full Kitchen', 'max_guests' => 6, 'area' => 120, 'img' => 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 2, 'room_number' => 'The Presidency', 'branch_id' => 1, 'room_type_id' => 4, 'price_per_night' => 600000, 'type_name' => 'Presidential Suite', 'desc' => 'Top-tier suite with panoramic views, private dining, and butler', 'amenities' => 'WiFi, Private Dining, Butler Service, Jacuzzi, Living Room', 'max_guests' => 4, 'area' => 80, 'img' => 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 3, 'room_number' => 'The Palm Suite', 'branch_id' => 1, 'room_type_id' => 3, 'price_per_night' => 350000, 'type_name' => 'Luxury Suite', 'desc' => 'Spacious suite with jacuzzi and cityscape', 'amenities' => 'WiFi, Living Room, Jacuzzi, Full Bar, Butler Service', 'max_guests' => 3, 'area' => 60, 'img' => 'https://images.unsplash.com/photo-1595576508898-0ad5c879a061?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 4, 'room_number' => 'The Lotus Suite', 'branch_id' => 1, 'room_type_id' => 3, 'price_per_night' => 350000, 'type_name' => 'Luxury Suite', 'desc' => 'Elegant suite with separate living area and premium amenities', 'amenities' => 'WiFi, Living Room, Jacuzzi, Full Bar, Butler Service', 'max_guests' => 3, 'area' => 60, 'img' => 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 5, 'room_number' => 'The Orchid Suite', 'branch_id' => 1, 'room_type_id' => 3, 'price_per_night' => 350000, 'type_name' => 'Luxury Suite', 'desc' => 'Refined furnishings with exclusive perks and city views', 'amenities' => 'WiFi, Living Room, Jacuzzi, Full Bar, Butler Service', 'max_guests' => 3, 'area' => 60, 'img' => 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 6, 'room_number' => 'Obsidian', 'branch_id' => 1, 'room_type_id' => 2, 'price_per_night' => 180000, 'type_name' => 'Executive Room', 'desc' => 'Premium business amenities with lounge access', 'amenities' => 'WiFi, Mini Bar, TV, Lounge Access, Coffee Machine', 'max_guests' => 2, 'area' => 45, 'img' => 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 7, 'room_number' => 'Amethyst', 'branch_id' => 1, 'room_type_id' => 2, 'price_per_night' => 180000, 'type_name' => 'Executive Room', 'desc' => 'Refined furnishings with exclusive perks', 'amenities' => 'WiFi, Mini Bar, TV, Lounge Access, Coffee Machine', 'max_guests' => 2, 'area' => 45, 'img' => 'https://images.unsplash.com/photo-1582719508461-905c673771fd?w=400&h=280&fit=crop', 'status' => 'available'],
                ['id' => 8, 'room_number' => 'Garnet', 'branch_id' => 1, 'room_type_id' => 2, 'price_per_night' => 180000, 'type_name' => 'Executive Room', 'desc' => 'Perfect for business travelers', 'amenities' => 'WiFi, Mini Bar, TV, Lounge Access, Coffee Machine', 'max_guests' => 2, 'area' => 42, 'img' => 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=400&h=280&fit=crop', 'status' => 'available'],
            ];
